          ...
          <FormGroup controlId='formControlsText' className='form-inner'>
            ...
            <div className='form-row'>
              <FormGroup className='form-group col-xs-12 col-sm-6 col-md-6'>
                ...
                <HelpBlock id='help-work-update'></HelpBlock>
                <FormControl className='form-control' type='text' name='work' id='work-update' list='data-works-update' placeholder='Henry V' onChange={this.handleChange} value={this.state.work} />
              </FormGroup>
              <FormGroup className='form-group col-xs-6 col-sm-3 col-md-3'>
                <ControlLabel>Act</ControlLabel>
                <HelpBlock id='help-act-update'></HelpBlock>
                <FormControl className='form-control' type='text' name='act' id='act-update' placeholder='3' onFocus={this.handleFocus.bind(this, 'act')} onChange={this.handleChange} value={this.state.act} />
              </FormGroup>
              <FormGroup className='form-group col-xs-6 col-sm-3 col-md-3'>
                <ControlLabel>Scene</ControlLabel>
                <HelpBlock id='help-scene-update'></HelpBlock>
                <FormControl className='form-control' type='text' name='scene' id='scene-update' placeholder='1' onFocus={this.handleFocus.bind(this, 'scene')}  onChange={this.handleChange} value={this.state.scene} />
              </FormGroup>
            </div>
            <div className='form-row'>
              <FormGroup className='form-group col-xs-12 col-sm-12 col-md-12'>
                <ControlLabel>Quote</ControlLabel>
                <HelpBlock id='help-quote-update'></HelpBlock>
                <FormControl className='form-control' type='text' name='quote' id='quote-update' placeholder='Once more unto the breach, dear friends, once more' onFocus={this.handleFocus.bind(this, 'quote')}  onChange={this.handleChange} value={this.state.quote} />
              </FormGroup>
            </div>
            <div className='form-row'>
              <FormGroup className='form-group col-xs-12 col-sm-12 col-md-12'>
                <ControlLabel>Tags (e.g. courage, family)</ControlLabel>
                <HelpBlock id='help-tags-update'></HelpBlock>
                <FormControl className='form-control' type='text' name='tags' id='tags-update' placeholder='courage, friends, battle, comraderie' onFocus={this.handleFocus.bind(this, 'tags')}  onChange={this.handleChange} value={this.state.tags}  />
              </FormGroup>
            </div>
